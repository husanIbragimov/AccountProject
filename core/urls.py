...
urlpatterns = [
    ...
    path('reset-password/', auth_view.PasswordResetView.as_view(template_name='account/password_reset_form.html'),
         name='password_reset'),
    path('reset-password-done/', auth_view.PasswordResetDoneView.as_view(template_name='account/reset_password_done.html'), name='password_reset_done'),
    path('reset-confirm/<uidb64>/<token>/', auth_view.PasswordResetConfirmView.as_view(template_name='account/reset-confirm.html'),
         name='password_reset_confirm'),
    path('reset-complete/', auth_view.PasswordResetCompleteView.as_view(template_name='account/reset-complete.html'), name='password_reset_complete'),
